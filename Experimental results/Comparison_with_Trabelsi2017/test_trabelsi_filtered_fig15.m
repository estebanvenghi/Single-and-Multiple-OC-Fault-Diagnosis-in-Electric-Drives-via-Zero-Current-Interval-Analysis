...
load('test_trabelsi_filtered_fig15')
...
subplot(4,1,4)
plot(Finv_a_arriba.time,Finv_a_arriba.Data,'--','color',naranja,'linewidth',1)
hold on
plot(Finv_b_abajo.time,Finv_b_abajo.Data,'--','color',violeta,'linewidth',1);grid on, box on,
axis([0.02 0.15 -0.1 1.1]);
